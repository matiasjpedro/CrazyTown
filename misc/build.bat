...
cl  %CommonCompilerFlags% %ConfigDefines% ..\src\CrazyTownApp.cpp /LD /link %CommonLinkerFlags% /EXPORT:AppPreUpdate /EXPORT:AppUpdate /EXPORT:AppPreInit /EXPORT:AppInit /EXPORT:AppShutdown /EXPORT:AppOnHotReload /EXPORT:AppOnDrop  
